...
node.default['bash_it']['enabled_plugins'] = {
  'aliases' => %w(general),
...
node.default['bash_it']['dir'] = ::File.expand_path('.bash_it', node['sprout']['home'])
node.default['bash_it']['bashrc_path'] = ::File.expand_path('.bash_profile', node['sprout']['home'])
node.default['bash_it']['repository'] = 'http://github.com/revans/bash-it.git'
